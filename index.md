...
<section id="about">
  ...
  <div class="about-content">
    <div class="about-text">
      <p>
        I'm a product manager passionate about leveraging <span class="about-highlight">AI-powered tools</span> 
      ...
      <p>
        When I'm not coding, I'm usually experimenting with new AI models and 
        showcasing my learnings to help others navigate the rapidly evolving fintech and AI landscape.
      </p>
    </div>
...
<section id="skills">
  ...
  <div class="skills-grid">
    ...
    <div class="skill-category">
      <h3 class="skill-category-title">Financial Engineering</h3>
      <div class="skill-list">
        <span class="skill-item">Treasury & Liquidity</span>
        <span class="skill-item">Interest Rates</span>
        <span class="skill-item">Derivatives Pricing</span>
        <span class="skill-item">Margining & Collateral</span>
      </div>
    </div>
  </div>
</section>
...
<section id="contact">
  ...
  <div class="contact-content">
    ...
    <div class="contact-links">
      <a href="https://github.com/davidwyh-dev" target="_blank" rel="noopener" class="contact-link" title="GitHub">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
        </svg>
      </a>
      <a href="https://www.linkedin.com/in/david-wong-86926814/" target="_blank" rel="noopener" class="contact-link" title="LinkedIn">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <a href="mailto:davidwyh@gmail.com" class="contact-link" title="Email">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="mailto:davidwyh@gmail.com" class="contact-email">davidwyh@gmail.com</a>
  </div>
</section>
